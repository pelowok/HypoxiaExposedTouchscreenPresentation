package screens
{
	...
	public class Screen20Graphic1 extends DisplayObjectContainer
	{
		...
		public function Screen20Graphic1()
		{
		...
		private function OnAddedToStage(e:Event):void	
		{
			...
			trace("Screen20Graphic1 added to stage");
		...
		private function DrawScreen():void
		{
			...
			list.push(img1 = PlaceImage( img1, "Graphic10" ) );
			
			list.push(img2 = PlaceImage( img2, "Graphic11" ) );
			
			list.push(img3 = PlaceImage( img3, "Graphic12" ) );
			
			list.push(img4 = PlaceImage( img4, "Graphic13" ) );
			
			list.push(img5 = PlaceImage( img5, "Graphic14" ) );
