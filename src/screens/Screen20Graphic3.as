package screens
{
	...
	public class Screen20Graphic3 extends DisplayObjectContainer
	{
		...
		public function Screen20Graphic3()
		{
		...
		private function OnAddedToStage(e:Event):void	
		{
			...
			trace("Screen20Graphic3 added to stage");
		...
		private function DrawScreen():void
		{
			...
			list.push(img1 = PlaceImage( img1, "Graphic30" ) );
			
			list.push(img2 = PlaceImage( img2, "Graphic31" ) );
			
			list.push(img3 = PlaceImage( img3, "Graphic32" ) );
			
			list.push(img4 = PlaceImage( img4, "Graphic33" ) );
			
			list.push(img5 = PlaceImage( img5, "Graphic34" ) );
